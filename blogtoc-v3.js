...
function showEntries(entries){
    ...
    s += "<br/>";
    s += "<div style='text-align:right; margin-top:10px; font-family:Arial; font-size:85%'>";
    s += "Widget by ";
    s += "<a href='http://infotentangblog.blogspot.com/' target='_blank' rel='nofollow' title='Sumber asli'>Info Blog</a>";
    s += " | Edit by ";
    s += "<a href='http://ruangsc.blogspot.com/2010/02/membuat-daftar-isi-blog-pada-halaman.html' target='_blank' title='Cara membuat Table of Content Widget'>SC Community</a>";
    s += "</div>";
...
function showHeaderOption(){
    ...
    s += "<option value='1title'/>Judul Artikel";
    s += "</select>";
    s += "<tr>";
    s += "<td style='text-align:right'>Lihat kategori: ";
